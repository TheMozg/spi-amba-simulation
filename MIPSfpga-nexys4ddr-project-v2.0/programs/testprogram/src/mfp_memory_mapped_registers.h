...
#define UART_TX_DATA_ADDR       0xBF400000
#define UART_TX_CTRL_ADDR       0xBF400004
#define UART_TX_DVDR_ADDR       0xBF400008
...
#define UART_TX_DATA            (* (volatile unsigned *) UART_TX_DATA_ADDR      )
#define UART_TX_CTRL            (* (volatile unsigned *) UART_TX_CTRL_ADDR      )
#define UART_TX_DVDR            (* (volatile unsigned *) UART_TX_DVDR_ADDR      )
