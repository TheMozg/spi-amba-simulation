...
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { SPI_MISO_IN }]; #IO_L23N_T3_35 Sch=jc[1]
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { SPI_MOSI_OUT }]; #IO_L19N_T3_VREF_35 Sch=jc[2]
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { SPI_SCLK_OUT }]; #IO_L22N_T3_35 Sch=jc[3]
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { SPI_SS_OUT }]; #IO_L19P_T3_35 Sch=jc[4]
