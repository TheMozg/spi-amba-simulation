...
SYSTEMC_SRC_DIR     := src src/div_clk src/spi src/bus_interconnect
...
CXX                 := g++
CXXFLAGS            := -std=c++98 -g -Wall -Wextra -I$(SYSTEMC_THD_INS_DIR)/include $(foreach dir,$(SYSTEMC_SRC_DIR),-I$(dir)) -pthread
